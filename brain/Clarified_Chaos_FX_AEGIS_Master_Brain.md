---
title: Clarified Chaos FX — AEGIS Master Brain
version: 1.1.0
updated: 2026-07-27
role: Canonical illustrated strategy and course knowledge base for Codex
strategy: AEGIS
archive: The Archive
---
...
![Course skill tree and What–Where–How–When architecture](assets/01_strategy_skilltree.jpg)
...
![Literal CBR checklist from Example 3](assets/02_cbr_checklist.jpg)
...
![Direction separated from range, trending range and trend condition](assets/03_condition_vs_direction.jpg)
...
![Do not trade when condition is unclear](assets/04_condition_no_trade.jpg)
...
![Candle behavior as compressed market structure](assets/05_candle_behavior.jpg)
...
![Duration of price rather than timeframe labels](assets/06_duration_not_timeframe.jpg)
...
![Example of the second nested shift](assets/07_t2_second_shift.jpg)

> **Supporting source — Entry Model, 02:35.** The course diagram distinguishes a larger shift from a nested fractal shift.

![Larger shift and nested fractal shift](assets/08_fractal_shift.jpg)
...
![Risk-adjusted return and drawdown priorities](assets/11_risk_priority_drawdown.jpg)
...
![Limit trade frequency and session length](assets/13_trade_frequency_limit.png)

![Set a daily loss limit and shutdown structure](assets/14_daily_loss_limit.png)
...
![Estimated losing-streak probability heatmap](assets/12_losing_streak_heatmap.jpg)
...
![System comes before the behavior gap](assets/15_psychology_system_first.png)
...
![Metacognition and the self pyramid](assets/16_metacognition_pyramid.png)
...
![Example 1 live entry, stop and target geometry](assets/09_example1_entry_geometry.jpg)
...
![Example 1 target reached](assets/10_example1_target_reached.jpg)
...
![Example 3 replay analytics](assets/17_example3_results.jpg)
