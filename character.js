...
import { characterMetrics, levelFromXp } from "./activity-metrics.js?v=body-xp-calibration-v1";
...
class CharacterLifeScene {
  constructor(canvas, levels) {
    ...
    {
      const actionSources = {
        couch: "assets/generated/aegis-character-room-layout-v2-couch-loop.png",
        fridge: "assets/generated/aegis-character-room-layout-v2-fridge-loop.png",
        desk: "assets/generated/aegis-character-room-layout-v2-desk-loop.png",
      };
...
async function exportSystemData(button) {
  ...
  const tables = [
    ...
    "deep_work_logs", "capability_skills", "capability_skill_logs", "business_projects", "business_capital_entries", "business_assets", "content_items", "financial_foundations", "activity_events",
