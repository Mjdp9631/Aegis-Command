...
function briefingDiagram(key) {
  ...
  if (key === "condition") return frame(`<text x="38" y="31" class="diagram-label">CONDITION MAP / DIRECTION IS SEPARATE</text><g class="condition-card"><rect x="38" y="55" width="132" height="112" rx="8"/><text x="49" y="76" class="diagram-title">RANGE</text><path class="diagram-line amber" d="M50 130L70 105L91 139L113 90L137 132L158 100"/><path class="condition-bound" d="M48 91H160M48 144H160"/><text x="48" y="158" class="diagram-small">EXTREME → BALANCE</text></g><g class="condition-card"><rect x="186" y="55" width="132" height="112" rx="8"/><text x="197" y="76" class="diagram-title">BULL TR</text><path class="diagram-line blue" d="M198 137L220 116L239 125L260 91L281 103L306 75"/><text x="197" y="158" class="diagram-small">50–75% / PRO-DIR</text></g><g class="condition-card"><rect x="334" y="55" width="132" height="112" rx="8"/><text x="345" y="76" class="diagram-title">BEAR TR</text><path class="diagram-line amber" d="M346 81L367 103L387 95L409 132L430 121L455 150"/><text x="345" y="158" class="diagram-small">50–75% / PRO-DIR</text></g><g class="condition-card"><rect x="482" y="55" width="120" height="112" rx="8"/><text x="494" y="76" class="diagram-title">TREND</text><path class="diagram-line blue" d="M494 137L514 116L531 123L548 95L565 104L588 72"/><text x="494" y="158" class="diagram-small">&lt;50% / 25% CONT.</text></g><path class="diagram-divider" d="M38 194H602"/><text x="38" y="220" class="diagram-label">BEARISH CBR EXAMPLE / HIGH SWEPT → LOW BROKEN → DIRECTION REVERSES</text><path class="diagram-line amber" d="M68 284L121 248L171 263L226 208L280 230L330 172"/><path class="diagram-sweep" d="M330 172L353 154L376 179"/><text x="294" y="146" class="diagram-small">PRIOR HIGH SWEPT</text><path class="diagram-level" d="M68 263H282"/><text x="75" y="257" class="diagram-small">RELEVANT PRIOR LOW</text><path class="diagram-line red" d="M376 179L414 207L458 231L506 267L555 291"/><path class="diagram-shift" d="M506 267V316"/><text x="471" y="326" class="diagram-stop-text">DECISIVE LOW BREAK → BEARISH STRUCTURE</text><text x="38" y="350" class="diagram-note">A CONFIRMED BEARISH REVERSAL MUST CONTINUE DOWN AFTER THE BREAK.</text>`, "Range, bullish and bearish trending range, trend, and bearish CBR condition map");
  if (key === "location") return frame(`<text x="38" y="31" class="diagram-label">ENTRY-50 / MEASURE THE STRUCTURE-BREAKING IMPULSE</text><path class="diagram-axis" d="M67 309H586 M67 65V309"/><path class="diagram-line blue" d="M84 277L141 252L192 270L246 229L304 104L364 142L419 185L471 162L535 204"/><circle class="diagram-anchor" cx="246" cy="229" r="7"/><circle class="diagram-anchor" cx="304" cy="104" r="7"/><text x="183" y="252" class="diagram-title">IMPULSE LOW</text><text x="312" y="94" class="diagram-title">IMPULSE HIGH</text><path class="diagram-fib" d="M246 166H304"/><path class="diagram-fib-guide" d="M275 104V229"/><rect x="218" y="151" width="114" height="30" rx="5" class="diagram-entry-zone"/><text x="234" y="171" class="diagram-target-text">50% / ENTRY-50</text><path class="diagram-line amber" d="M304 104L285 139L275 166L291 151"/><circle class="diagram-pulse" cx="275" cy="166" r="7"/><text x="353" y="161" class="diagram-small">RETRACEMENT INTO ENTRY-50</text><path class="diagram-bracket" d="M84 294V303H246V294"/><text x="91" y="331" class="diagram-note">AOI-50 = BROADER MOVE / LOCATION</text><path class="diagram-bracket amber" d="M304 213V224H535V213"/><text x="375" y="248" class="diagram-note">TARGET-50 = EXPECTED DESTINATION</text><text x="67" y="351" class="diagram-note">LOW → HIGH → 50% OF THAT IMPULSE = ENTRY REFERENCE. DO NOT MERGE WITH AOI OR TARGET.</text>`, "Entry fifty drawn from impulse low and impulse high");
